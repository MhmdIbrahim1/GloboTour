...
object VacationSpots {
    ...
    private val images = arrayListOf(
        R.drawable.thumb_8_0, R.drawable.thumb_8_1, R.drawable.thumb_8_2,
        R.drawable.thunb_8_3, R.drawable.thumb_8_4, R.drawable.thumb_8_5,
        R.drawable.thumb_8_6, R.drawable.thumb_8_7, R.drawable.thumb_8_8,
        R.drawable.thumb_8_9, R.drawable.thumb_4_5, R.drawable.thumb_4_6,
    ...
    private val cityNames = arrayListOf(
        "Cairo", "Aswan", "Luxor", "Alexandria", "Sharm El Sheikh",
        "Hurghada", "6th of October", "Port Said", "Ismailia", "Faiyum",
